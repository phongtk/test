'use strict';
angular.module('rmsSystem').controller('InfoCtrl', function ($scope, $q, $http, geoJson, $cookieStore, $filter, Area, Station, User, $timeout, growl, uiGridConstants, uiGridGroupingConstants,DTOptionsBuilder, DTColumnBuilder,DTColumnDefBuilder){
    $scope.dataTableHour = {};
...
// Water chart
    ...
    var pushData8WaterRain = function (record, index) {
        ...
        var waterData = validateValue(record.g_dat[1], false);
